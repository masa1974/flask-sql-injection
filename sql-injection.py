...
app.secret_key = 'sql-injection'

DATABASE_PATH = os.path.join(os.path.dirname(__file__), 'database.db')

def init():
    users = [
        ('user1', '123456', 'Welcome'),
        ('user2', '123456', 'Welcome')
    ]
...
def check():
        ...
        if r1.text=="Welcome" and r2.text=="Error" and r3.text=="Error":
           check_result= "SQL injection fixed"
        else:
